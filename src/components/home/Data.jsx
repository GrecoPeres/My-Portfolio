...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Greco Peres
            <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
        ...
        <p className="home__description">Eu sou um desenvolvedor de sistemas, apaixonado pela área da programação e com muita sede de aprendizagem.</p>
